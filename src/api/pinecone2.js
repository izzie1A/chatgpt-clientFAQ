...
const pc = new Pinecone({ apiKey: `${import.meta.env.VITE_OPENAI_API_KEY}` })

// To get the unique host for an index, 
// see https://docs.pinecone.io/guides/manage-data/target-an-index
const namespace = pc.index("developer-quickstart-js", "aws").namespace("example-namespace");
...
// Upsert the records into a namesp                                           ace
